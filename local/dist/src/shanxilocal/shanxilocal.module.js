...
let ShanxilocalModule = class ShanxilocalModule {
};
ShanxilocalModule = __decorate([
    common_1.Module({
        imports: [typeorm_1.TypeOrmModule.forFeature([shanxilocal_entity_1.shanxilocal])],
        providers: [shanxilocal_service_1.ShanxilocalService],
        controllers: [shanxilocal_controller_1.ShanxilocalController]
    })
], ShanxilocalModule);
exports.ShanxilocalModule = ShanxilocalModule;
//# sourceMappingURL=shanxilocal.module.js.map