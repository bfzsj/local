...
let UserInformationService = class UserInformationService {
    ...
    save(username) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userRepository.save(username);
        });
    }
    remove(username) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userRepository.remove(username);
        });
    }
};
UserInformationService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(user_information_entity_1.user_information)),
